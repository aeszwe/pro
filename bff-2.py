...
def log_x():
    ...
    pilih_masuk()
def pilih_masuk():
    anjar = raw_input('\x1b[1;95m#\x1b[1;92m \x1b[1;96mPilih\x1b[1;91m > \x1b[1;93m')
    if anjar == '':
        print '\x1b[1;91m• Wrong Input '
        time.sleep(1.0)
        pilih_masuk()
    elif anjar == '1' or anjar == '01':
        token()
    elif anjar == '2' or anjar == '02':
        kuki()
    elif anjar == '3' or anjar == '03':
        tik()
        os.sys.exit()
    elif anjar == '4' or anjar == '04':
        tik()
        os.sys.exit()
    elif anjar == '0' or anjar == '00':
    	print ''
